...
function ShowQuestionForm() {
    ...
    var create = 'Share';
    $("#app").html("");
    $("#app").append('<img src="images/EGG-1.png" class="omlet_first"></img><p>Title</p><div><input class="form_format" style="height:70px;" id="question" value="'+poll_question+'"></input></div><div id="responses"></div><div id="moreResponses"><img src="images/option.png" weight="270px" height="32px"></img> </div><div id="submit">'+create+'</div></div>');
    ...
    for(var i = 0; i < myDoc.pollCounts.length; i++) {
        ...
        var option_text = 'Item';
        $("#responses").append("<p>"+option_text+" "+ option + "</p><input value='" + myDoc.poll["response"+i] + "' id='answer"+i+"' class='form_format' type='text'>");
        // var letter = String.fromCharCode(65 + i);
    ...
    // $("#app").html("<input>sdfsdf</input>" + JSON.stringify(myDoc.poll));
    // $("#app").html("<input>sdfsdf</input>");
